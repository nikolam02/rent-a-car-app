...
<title>Balkan Drive | Admin panel</title>
...
if(isset($_SESSION['admin_name']))
{
    ...
    <form action="dodajMenadzera.php" method="post">
    <input type="submit" value="Dodaj menadzera" class="buttonMenu" name="dodajMenadzera">
    </form>
    ...
    if($_SESSION['admin_name']=='Nikola' && $_SESSION['admin_lastname']=='Matejic')
    {
        ?>
    ...
    // uspesno ubacen novi menadzer
    if(isset($_SESSION['noviMenadzer']))
    {
        echo"<span class='uspesnoUbacen'>".$_SESSION['noviMenadzer']."</span>";
        unset($_SESSION['noviMenadzer']);
    }
